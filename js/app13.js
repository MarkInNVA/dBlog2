define([
    ...
    "dojo/store/JsonRest", "dojo/topic", "dojo/_base/fx", "dojox/gfx",
     "custom/gridWidget/gridWidget", "js/util13", "js/module"
],
...
// 
            	...
            	var grid, photoHandle; //, onH, backButton = domConstruct.create("button", {id: "backButton", innerHTML:"To Main"});
                ...
                photoHandle = topic.subscribe("havePhoto", function(data)  {
	                	...
	                	// photoHandle.remove();
						// console.log("top of subscribe()  photo:", photoId);					
                       		onEnd: {
				                    thumbnailStore.query("/" + data.id).then(function(photo) {
